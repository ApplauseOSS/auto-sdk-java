...
import com.applause.auto.util.applausepublicapi.dto.DictionaryValueDto;
...
public interface DictionariesApi {
   ...
   */
  @GET("v2/dictionaries")
  CompletableFuture<Response<List<String>>> getDictionaries();

  /**
   * Returns values for a selected dictionary
   *
   * @param dictionaryType (required)
   * @return List&lt;DictionaryValueDto&gt;
   */
