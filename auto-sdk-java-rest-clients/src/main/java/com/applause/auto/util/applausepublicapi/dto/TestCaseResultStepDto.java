 ...
 * @param stepResult -- GETTER -- Get stepResult
 * @param attachments -- GETTER -- Get attachments
 * @param linkedIssues -- GETTER -- Get linkedIssues
 */
public record TestCaseResultStepDto(
    Long stepNumber,
    String instruction,
    String expectedResult,
    String actualResult,
    NamedEntityDto stepResult,
    List<AttachmentDto> attachments,
    List<LinkedIssueDto> linkedIssues) {}
