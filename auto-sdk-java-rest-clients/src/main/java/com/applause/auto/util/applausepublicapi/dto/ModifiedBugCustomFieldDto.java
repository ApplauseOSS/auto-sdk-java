 ...
 */
public record ModifiedBugCustomFieldDto(
    Long id,
    PatchValueDtoString description,
    PatchValueDtoCustomFieldType fieldType,
    PatchValueDtoInteger order,
    ModifiedBugCustomFieldOptionsDto options) {}
