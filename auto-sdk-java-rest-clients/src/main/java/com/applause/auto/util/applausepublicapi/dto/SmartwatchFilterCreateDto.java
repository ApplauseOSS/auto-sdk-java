 ...
 */
public record SmartwatchFilterCreateDto(
    @SerializedName("parentFilterId") Long parentFilterId,
    EnvironmentFilterTypeEnum environmentFilterType,
    @SerializedName("web") Boolean web,
    @SerializedName("smartwatch") List<Long> smartwatch) {}
