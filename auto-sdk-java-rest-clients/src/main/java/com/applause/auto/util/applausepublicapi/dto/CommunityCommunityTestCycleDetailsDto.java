...
import com.applause.auto.util.applausepublicapi.dto.enums.FrequencyEnum;
...
/**
 * CommunityCommunityTestCycleDetailsDto
 *
 ...
 * @param scope -- GETTER -- Get scope
 * @param instructions -- GETTER -- Get instructions
 * @param settings -- GETTER -- Get settings
 ...
 */
public record CommunityCommunityTestCycleDetailsDto(
    Long id,
    String name,
    Date startDate,
    Date closeDate,
    ...
    Boolean appInAppStore,
    CommunityTestCycleScopeDto scope,
    CommunityTestCycleInstructionsDto instructions,
    CommunityTestCycleSettingsDto settings,
