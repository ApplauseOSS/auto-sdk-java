...
@Implementation(is = TestComponentWithFakeElementsFirefox.class, on = Platform.WEB_DESKTOP_FIREFOX)
public class TestComponentWithFakeElements extends BaseComponent {
  @Override
  public void afterInit() {
    afterInitElement.initialize();
    shadowDomHost.linkShadowRoot();
  }
  ...
  @Locate(using = Strategy.ID, value = "%s")
  public ContainerElement idWildcard;
  ...
  @Locate(using = Strategy.ID, value = "not-present")
  ...
  @Locate(using = Strategy.ID, value = "shadow-host-open", shadowRoot = true)
  public TestComponentShadowDomSub shadowDomHost;
}
